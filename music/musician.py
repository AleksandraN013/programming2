...
# Run setters and getters in the debugger
george = Musician('George Harrison')
print(george == Musician('George Harrison', is_band_member=False))
...
# Calling methods
george = Musician('George Harrison')
print(george.play('Why My Guitar Gently Weeps', 'Thank you!', 'Thanks!', goodbye='Goodbye!'))
print()
print(george.play_song('Why My Guitar Gently Weeps', 'Thank you!', 'Thanks!', goodbye='Goodbye!'))
